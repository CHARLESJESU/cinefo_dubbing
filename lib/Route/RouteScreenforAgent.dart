...
//
//
// class RoutescreenforDubbing extends StatefulWidget {
//   final int initialIndex;
//
//   const RoutescreenforDubbing(
//       {super.key, this.initialIndex = 0}); // Default to Home tab
//
//   @override
//   State<RoutescreenforDubbing> createState() => _RoutescreenforDubbingState();
// }
//
// class _RoutescreenforDubbingState extends State<RoutescreenforDubbing> {
//   int _currentIndex = 0;
//
//   @override
//   void initState() {
